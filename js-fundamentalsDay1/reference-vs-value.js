...
console.log(x); // ? answer: x is 5 y gets a copy of x's value starts at 5
console.log(y); // ?        then y changes to 99. changing y later doesnt effect x
...
console.log(obj1.score); // ? 99  objects and array get copied by reference/address
