...
function getPassingStudents(students) {
  return students.filter(stu => stu.score >= 70);
}
...
function getTotalScore(students) {
  // TODO: write your code here
  return students.reduce((acc, s) => acc + s.score, 0);
